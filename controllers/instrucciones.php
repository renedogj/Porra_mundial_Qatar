	...
	<div class="divContenidoIntrucciones">
		...
		<ol>
			...
			<li>
				...
				<br><br>
				<b>Resumen puntuación fase de grupos y la repesca:</b><br>
			...
			<li>
				...
				Los 3 puntos que podiamos obtener hasta ahora, se irán multiplicando con el objetivo de que no haya gente que se quede sin posibilidad de un buen puesto.
				<ul>
