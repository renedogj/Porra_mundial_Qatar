...
if(checkBlackList($auxEmail, $blackList) && checkBlackList($auxNombre, $blackList) && checkBlackList($auxPassword, $blackList)) {
	try {
		...
		setcookie("id", $id, time() + 86400, "/dificultades/dif2/");
		setcookie("nombre", $nombre, time() + 86400, "/dificultades/dif2/");
		setcookie("puntuacion", 0, time() + 86400, "/dificultades/dif2/");
		setcookie("email", $email, time() + 86400, "/dificultades/dif2/");
